...
//        size = new SizeF(size.getWidth(), size.getHeight());
    ...
    public class Configurator {
        ...
        public Configurator onShow(OnShowListener onShowListener) {
        ...
        public void load() {
            ...
            PDFView.this.callbacks.setOnScroll(mOnScrollListener);
            PDFView.this.callbacks.setOnShow(mOnShowListener);
