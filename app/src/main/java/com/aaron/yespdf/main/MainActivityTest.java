 ...
 */
public class MainActivityTest extends CommonActivity implements IMainContractTest.V {
    ...
    private IMainContractTest.P presenter;
    ...
    @Override
    public void attachP() {
        presenter = new MainPresenterTest(this);
    }
    ...
    private void setListener() {
        ibtnCancel.setOnClickListener(v -> hideOperationBar());
            ...
            PermissionUtils.permission(PermissionConstants.STORAGE)
                    .callback(new PermissionUtils.SimpleCallback() {
                        ...
                        public void onGranted() {
                            ...
                            SelectActivity.start(MainActivityTest.this, SELECT_REQUEST_CODE, imported);
                        }
