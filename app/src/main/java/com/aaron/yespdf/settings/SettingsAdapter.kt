...
internal class SettingsAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    companion object {
        ...
        private const val POS_VOLUME_CONTROL = 1
        private const val POS_CLICK_FLIP_PAGE = 2
        private const val POS_SHOW_STATUS_BAR = 3
        private const val POS_KEEP_SCREEN_ON = 4
