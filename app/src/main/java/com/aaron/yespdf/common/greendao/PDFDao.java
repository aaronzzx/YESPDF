...
public class PDFDao extends AbstractDao<PDF, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Position = new Property(10, int.class, "position", false, "POSITION");
        public final static Property ScaleFactor = new Property(11, float.class, "scaleFactor", false, "SCALE_FACTOR");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PDF\" (" + //
                ...
                "\"POSITION\" INTEGER NOT NULL ," + // 10: position
                "\"SCALE_FACTOR\" REAL NOT NULL );"); // 11: scaleFactor
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, PDF entity) {
        ...
        stmt.bindLong(11, entity.getPosition());
        stmt.bindDouble(12, entity.getScaleFactor());
    }
    ...
    public PDF readEntity(Cursor cursor, int offset) {
        PDF entity = new PDF( //
            ...
            cursor.getLong(offset + 9), // latestRead
                cursor.getInt(offset + 10), // position
                cursor.getFloat(offset + 11) // scaleFactor
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PDF entity, int offset) {
        ...
        entity.setPosition(cursor.getInt(offset + 10));
        entity.setScaleFactor(cursor.getFloat(offset + 11));
     }
