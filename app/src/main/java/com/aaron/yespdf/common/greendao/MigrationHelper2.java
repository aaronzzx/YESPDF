...
public class MigrationHelper2 {
    ...
    private static final String TAG = "MigrationHelper2";

    private static MigrationHelper2 instance;

    public static MigrationHelper2 getInstance() {
        if(instance == null) {
            instance = new MigrationHelper2();
        }
        return instance;
    }
